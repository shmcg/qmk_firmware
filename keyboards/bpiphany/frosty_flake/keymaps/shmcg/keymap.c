...
[_QWERTY] = LAYOUT_tkl_ansi(\
                 ...
                 KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_HYPR, MO(ADJUST), KC_MEH, KC_LEFT, KC_DOWN, KC_RGHT ),
...
[_APPLE] = LAYOUT_tkl_ansi(\
                 ...
                 KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, \
                 KC_LCTL, KC_LALT, KC_LALT, KC_SPC, KC_RALT, KC_HYPR, KC_TRNS, KC_MEH, KC_LEFT, KC_DOWN, KC_RGHT ),
...
[_ADJUST] = LAYOUT_tkl_ansi(\
                 ...
                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_APP, KC_NO, KC_NO, KC_NO )
};
