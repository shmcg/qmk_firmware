...
[_QWERTY] = LAYOUT_tkl_ansi(\
                 ...
                 KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_MEH, KC_HYPR, KC_APP, ADJUST, KC_LEFT, KC_DOWN, KC_RGHT ),
...
[_APPLE] = LAYOUT_tkl_ansi(\
                 ...
                 KC_LCTL,KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, \
                 KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, \
                 KC_LCTL, KC_LALT, KC_LALT, KC_SPC, KC_MEH, KC_HYPR, KC_APP, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT ),
...
[_ADJUST] = LAYOUT_tkl_ansi(\
                 ...
                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MENU, KC_TRNS, KC_NO, KC_NO )
};
